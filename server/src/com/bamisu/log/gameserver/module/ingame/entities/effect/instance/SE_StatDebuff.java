 ...
 */
public class SE_StatDebuff extends Effect {
    public Attr attr;
    public float rate; //%

    public SE_StatDebuff(Character sourceActor, EEffect type, int turn, List<String> props, boolean isDisplay) {
        ...
        if(this.rate > maxRate) this.rate = maxRate;
    }
