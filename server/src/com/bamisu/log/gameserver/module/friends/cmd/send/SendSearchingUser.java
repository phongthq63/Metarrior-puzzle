...
public class SendSearchingUser extends BaseMsg {
    public List<BlockedFriendVO> list;
    public SendSearchingUser() {
        super(CMD.CMD_SEARCHING_USER);
    }

    public SendSearchingUser(short errorCode) {
        super(CMD.CMD_SEARCHING_USER, errorCode);
    }
