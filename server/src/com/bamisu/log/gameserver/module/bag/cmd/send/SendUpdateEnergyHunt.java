...
public class SendUpdateEnergyHunt extends BaseMsg {
    public UserBagModel userBagModel;
    public EnergyChargeInfo energyInfo;
    public Zone zone;

    public SendUpdateEnergyHunt() {
        super(CMD.CMD_UPDATE_HUNT_ENERGY_BAR);
    }

    public SendUpdateEnergyHunt(short errorCode) {
        super(CMD.CMD_UPDATE_HUNT_ENERGY_BAR, errorCode);
    }
