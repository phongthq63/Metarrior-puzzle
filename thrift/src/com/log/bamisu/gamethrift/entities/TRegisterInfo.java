...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2018-04-04")
public class TRegisterInfo implements org.apache.thrift.TBase<TRegisterInfo, TRegisterInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TRegisterInfo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TRegisterInfo");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TRegisterInfoStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TRegisterInfoTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TRegisterInfo.class, metaDataMap);
  }
   ...
   */
  public TRegisterInfo(TRegisterInfo other) {
  ...
  public TRegisterInfo deepCopy() {
    return new TRegisterInfo(this);
  }
  ...
  public TRegisterInfo setUid(long uid) {
    this.uid = uid;
    setUidIsSet(true);
    return this;
  }
  ...
  public TRegisterInfo setUname(String uname) {
    this.uname = uname;
    return this;
  }
  ...
  public TRegisterInfo setDname(String dname) {
    this.dname = dname;
    return this;
  }
  ...
  public TRegisterInfo setDid(String did) {
    this.did = did;
    return this;
  }
  ...
  public TRegisterInfo setLastlogin(int lastlogin) {
    this.lastlogin = lastlogin;
    setLastloginIsSet(true);
    return this;
  }
  ...
  public TRegisterInfo setCreated(int created) {
    this.created = created;
    setCreatedIsSet(true);
    return this;
  }
  ...
  public TRegisterInfo setChip(long chip) {
    this.chip = chip;
    setChipIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TRegisterInfo)
      return this.equals((TRegisterInfo)that);
    return false;
  }

  public boolean equals(TRegisterInfo that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TRegisterInfo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TRegisterInfo(");
    boolean first = true;
  ...
  private static class TRegisterInfoStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TRegisterInfoStandardScheme getScheme() {
      return new TRegisterInfoStandardScheme();
    }
  }

  private static class TRegisterInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<TRegisterInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TRegisterInfo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRegisterInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TRegisterInfoTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TRegisterInfoTupleScheme getScheme() {
      return new TRegisterInfoTupleScheme();
    }
  }

  private static class TRegisterInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRegisterInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TRegisterInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TRegisterInfo struct) throws org.apache.thrift.TException {
