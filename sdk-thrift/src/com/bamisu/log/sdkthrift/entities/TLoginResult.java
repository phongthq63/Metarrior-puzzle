...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.11.0)", date = "2020-05-07")
public class TLoginResult implements org.apache.thrift.TBase<TLoginResult, TLoginResult._Fields>, java.io.Serializable, Cloneable, Comparable<TLoginResult> {
  ...
  public String socialNetworkLinked; // required
  ...
  public TLoginResult setAccountID(String accountID) {
    this.accountID = accountID;
    return this;
  }
  ...
  public TLoginResult setAddr(String addr) {
    this.addr = addr;
    return this;
  }
  ...
  public TLoginResult setZone(String zone) {
    this.zone = zone;
    return this;
  }
  ...
  public TLoginResult setToken(String token) {
    this.token = token;
    return this;
  }
  ...
  public String getSocialNetworkLinked() {
    return this.socialNetworkLinked;
  }

  public TLoginResult setSocialNetworkLinked(String socialNetworkLinked) {
    this.socialNetworkLinked = socialNetworkLinked;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SOCIAL_NETWORK_LINKED:
      if (value == null) {
        ...
        setSocialNetworkLinked((String)value);
      }
      break;
  ...
  public int compareTo(TLoginResult other) {
    ...
    lastComparison = Boolean.valueOf(isSetSocialNetworkLinked()).compareTo(other.isSetSocialNetworkLinked());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSocialNetworkLinked()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TLoginResult(");
    boolean first = true;
