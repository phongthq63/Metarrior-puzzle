...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.11.0)", date = "2020-05-04")
public class TSwitchAccountResult implements org.apache.thrift.TBase<TSwitchAccountResult, TSwitchAccountResult._Fields>, java.io.Serializable, Cloneable, Comparable<TSwitchAccountResult> {
  ...
  public String loginKey; // required
  ...
  public TSwitchAccountResult setLoginKey(String loginKey) {
    this.loginKey = loginKey;
    return this;
  }
  ...
  public TSwitchAccountResult setAddr(String addr) {
    this.addr = addr;
    return this;
  }
  ...
  public TSwitchAccountResult setZone(String zone) {
    this.zone = zone;
    return this;
  }
  ...
  public int compareTo(TSwitchAccountResult other) {
    ...
    lastComparison = Boolean.valueOf(isSetLoginKey()).compareTo(other.isSetLoginKey());
    if (lastComparison != 0) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TSwitchAccountResult(");
    boolean first = true;
