...
public class SwitchAutoRetireHeroAction extends ClientAction {
    public SwitchAutoRetireHeroAction(Client client) {
        super(client);
    }
    ...
    public void doAction() {
        ...
        data.putInt(Params.CMD_ID, CMD.CMD_SWITCH_AUTO_RETIRE_HERO);
