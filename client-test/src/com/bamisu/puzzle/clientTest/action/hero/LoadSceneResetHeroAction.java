...
public class LoadSceneResetHeroAction extends ClientAction {
    public LoadSceneResetHeroAction(Client client) {
        super(client);
    }
    ...
    public void doAction() {
        ...
        data.putInt(Params.CMD_ID, CMD.CMD_LOAD_SCENE_RESET_HERO);
