...
public class LoadSceneGetListHeroAction extends ClientAction {
    public LoadSceneGetListHeroAction(Client client) {
        super(client);
    }
    ...
    public void doAction() {
        ...
        data.putInt(Params.CMD_ID, CMD.CMD_LOAD_SCENE_GET_LIST_HERO);
