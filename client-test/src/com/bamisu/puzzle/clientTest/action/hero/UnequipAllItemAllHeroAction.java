...
public class UnequipAllItemAllHeroAction extends ClientAction {
    public UnequipAllItemAllHeroAction(Client client) {
        super(client);
    }
    ...
    public void doAction() {
        ...
        data.putInt(Params.CMD_ID, CMD.CMD_UNEQUIP_ALL_ITEM_ALL_HERO);
