...
public class LoadSceneHeroBlessingAction extends ClientAction {
    public LoadSceneHeroBlessingAction(Client client) {
        super(client);
    }
    ...
    public void doAction() {
        ...
        data.putInt(Params.CMD_ID, CMD.CMD_LOAD_SCENE_HERO_BLESSING);
