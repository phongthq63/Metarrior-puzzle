...
public class LoadSceneRetireHeroAction extends ClientAction {
    public LoadSceneRetireHeroAction(Client client) {
        super(client);
    }
    ...
    public void doAction() {
        ...
        data.putInt(Params.CMD_ID, CMD.CMD_LOAD_SCENE_RETIRE_HERO);
