...
public class GetUserHeroCollectionAction extends ClientAction {
    public GetUserHeroCollectionAction(Client client) {
        super(client);
    }
    ...
    public void doAction() {
        ...
        data.putInt(Params.CMD_ID, CMD.CMD_GET_USER_HERO_COLLECTION);
