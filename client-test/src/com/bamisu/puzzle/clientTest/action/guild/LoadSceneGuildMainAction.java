...
public class LoadSceneGuildMainAction extends ClientAction {
    public LoadSceneGuildMainAction(Client client) {
        super(client);
    }
    ...
    public void doAction() {
        ...
        data.putInt(Params.CMD_ID, CMD.CMD_LOAD_SCENE_GUILD_MAIN);
