...
public class GetCurrentCampaignStateAction extends ClientAction {
    public GetCurrentCampaignStateAction(Client client) {
        super(client);
    }
    ...
    public void doAction() {
        ...
        data.putInt(Params.CMD_ID, CMD.GET_CURRENT_CAMPAIGN_STATE);
